...
let ddfd = document.createElement("div");
...
// class
wrapper.classList.add("wrapper-pizza");
left.classList.add("left");
img.classList.add("pizza");
ddfd.classList.add("ddfd");
h3.classList.add("pizza-title");
span.classList.add("pizza-span");
right.classList.add("right");

// text
h3.innerHTML = "Супер Микс большая";
span.innerHTML = "Тонкое";
plusBtn.innerHTML = "+";
minusBtn.innerHTML = "-";
countSpan.innerHTML = "0";

// attributes
img.src = "./assets/icons/94844930-5c66-4c12-a670-93b048169dbe.webp";
